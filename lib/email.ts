    ...
    <tr>
      <td align="center">
        <table class="email-container" role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 40px rgba(124,58,237,0.10),0 1px 4px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td class="content-pad" style="padding:44px 44px 36px;">${body}</td>
          </tr>
          <tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding-bottom:16px;text-align:center;">
                    <a href="${CLIENT()}" style="display:inline-block;margin:0 8px;color:#9ca3af;text-decoration:none;font-size:12px;font-weight:500;" target="_blank">Home</a>
                    <span style="color:#e5e7eb;">·</span>
                    <a href="${CLIENT()}/membership" style="display:inline-block;margin:0 8px;color:#9ca3af;text-decoration:none;font-size:12px;font-weight:500;" target="_blank">Membership</a>
                    <span style="color:#e5e7eb;">·</span>
                    <a href="${CLIENT()}/workbook" style="display:inline-block;margin:0 8px;color:#9ca3af;text-decoration:none;font-size:12px;font-weight:500;" target="_blank">Workbook</a>
                    <span style="color:#e5e7eb;">·</span>
                    <a href="${CLIENT()}/events" style="display:inline-block;margin:0 8px;color:#9ca3af;text-decoration:none;font-size:12px;font-weight:500;" target="_blank">Events</a>
                  </td>
                </tr>
                <tr>
                  <td style="text-align:center;">
                    <p style="margin:0 0 6px;font-size:12px;color:#9ca3af;line-height:1.6;">© ${new Date().getFullYear()} Reinvent You Over 50. All rights reserved.</p>
                    <p style="margin:0;font-size:11px;color:#c4b5fd;opacity:0.7;">You received this email because you interacted with our platform.</p>
                  </td>
                </tr>
              </table>
            </td>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px auto 4px;">
      <tr>
        <td style="border-radius:50px;background:linear-gradient(${gradient});">
          <a href="${url}" target="_blank" style="display:inline-block;padding:15px 36px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:-0.2px;border-radius:50px;">
            ${label} &rarr;
          </a>
        </td>
      </tr>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:12px auto 4px;">
      <tr>
        <td style="border-radius:50px;border:2px solid #e9d5ff;">
          <a href="${url}" target="_blank" style="display:inline-block;padding:13px 32px;font-size:14px;font-weight:600;color:#7c3aed;text-decoration:none;letter-spacing:-0.2px;border-radius:50px;">
            ${label}
          </a>
        </td>
      </tr>
...
export const sendOrderConfirmationEmail = async (
  ...
  const body = `
    ...
    ${bookingLink ? `${emailHighlight(`<strong>Book your 1-on-1 session:</strong> Use the button below to schedule it at your convenience.`, "#7c3aed", "#faf5ff")}${emailButton("Schedule My Session", bookingLink)}` : ""}
...
export const sendMembershipWelcomeEmail = async (
  ...
  const body = `
    ...
    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.75;">We're so excited to have you as part of the <strong style="color:#7c3aed;">Reinvent You Over 50</strong> community.</p>
    ${emailDataTable([
...
export const sendFreeResourceEmail = async (
  ...
  const body = `
    ...
    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.75;">Inside your <strong>Free Reinvention Guide</strong> you'll discover:</p>
    ${emailChecklist([
...
export const sendBookingConfirmationEmail = async (
  ...
  const body = `
    ...
    ${emailHighlight(`Need to reschedule? Reply to this email at least <strong>24 hours</strong> before your session.`, "#f59e0b", "#fffbeb")}
  `;
  await sendEmail({
    to: email,
...
export const sendContactAcknowledgementEmail = async (
  ...
  const body = `
    ...
    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.75;">Thank you for reaching out to <strong>Reinvent You Over 50</strong>. Our team will review your message and get back to you within <strong style="color:#7c3aed;">1–2 business days</strong>.</p>
...
export const sendEventRegistrationEmail = async (
  ...
  const body = `
    ...
    ${
      isVirtual
        ? emailHighlight(
            `Your <strong>virtual access link</strong> will be emailed to you 24 hours before the event.`,
            "#7c3aed",
            "#faf5ff",
          )
        : emailHighlight(
            `This is an <strong>in-person event</strong>. Please arrive 10–15 minutes early.`,
            "#0ea5e9",
            "#f0f9ff",
          )
    }
...
export const sendWorkbookPurchaseEmail = async (
  ...
  const body = `
    ...
    ${
      ...
      <p style="margin:0;font-size:14px;color:#78350f;line-height:1.7;">Our team will reach out within <strong>24 hours</strong> to schedule your coaching session.</p>
    </div>`
        : ""
    }
    ${emailHighlight(`<strong>30-Day Money-Back Guarantee:</strong> If you're not completely satisfied, email us within 30 days and we'll refund you in full.`, "#16a34a", "#f0fdf4")}
  `;
  await sendEmail({
    to: email,
    subject: isBundle
